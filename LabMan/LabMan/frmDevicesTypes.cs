...
namespace LabMan
{
    public partial class frmDevicesTypes : MaterialForm
    {
        public frmDevicesTypes()
        {
            InitializeComponent();
        ...
        private void frmDevicesTypes_Load(object sender, EventArgs e)
        {
        ...
        {
            var type = Type.GetType("LabMan.frmAddType");
            var form = Activator.CreateInstance(type) as Form;
            if (form != null)
            {
                form.MdiParent = this.ParentForm;
