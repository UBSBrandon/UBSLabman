...
namespace LabMan
{
    public partial class frmProducts : MaterialForm
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'uBSLABMN_MXDataSet.TPRODUCT' Puede moverla o quitarla según sea necesario.
            this.tPRODUCTTableAdapter.Fill(this.uBSLABMN_MXDataSet.TPRODUCT);
